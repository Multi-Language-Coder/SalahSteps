...
export class ThemeService {
  private themes: Theme[] = [
    {
      ...
      styles: {
        body: 'background-color: #0d422a !important; background-image: url("https://www.transparenttextures.com/patterns/arabesque.png"); font-family: "Poppins", sans-serif; color: #f5eeda; min-height: 100vh; background-position: center; background-repeat: repeat; background-attachment: fixed;',
    ...
    },
    {
      ...
      styles: {
        ...
        //e
        body2: 'background: linear-gradient(135deg, #659DBD 25%, #DAAD86 50%, #BC986A 75%, #FBEEC1 100%);font-family: "Poppins", sans-serif; color: #FFFFFF; min-height: 100vh; background-attachment: fixed;',
  ...
  private applyTheme(theme: Theme): void {
    ...
    body { ${theme.styles.body2} }
      ...
      .btn-success:active {
        background: rgba(255, 255, 255, 0.4) !important;
        border-color: rgb2a(255, 255, 255, 0.6) !important;
        transform: translateY(1px) !important;
        box-shadow: 0 4px 15px rgba(0, 0, 0, 0.3) !important;
      }
      #recitations { ${theme.styles.recitations} }
    `
      ...
      if((location.pathname.includes('extras') || location.pathname.includes('qibla')) && theme.name == 'teal-gradient'){
